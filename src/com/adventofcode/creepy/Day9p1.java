...
public class Day9p1 {
	...
	public static void main(String[] args) throws IOException {
		try (BufferedReader reader = new BufferedReader(new InputStreamReader(Day9p1.class.getResourceAsStream("/input-day9.txt")));) {
			String line;
		...
		System.out.println(findIt(places, 0, Integer.MAX_VALUE));
	}
